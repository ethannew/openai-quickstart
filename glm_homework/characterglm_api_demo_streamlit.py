...
def update_image_style():
    ...
    if debug:
        print(
            f'update_image_style. previous style = {st.session_state["IMAGE_STYLE"]}, current style = {style}'
        )
    st.session_state["IMAGE_STYLE"] = style
...
with st.container():
    ...
    st.selectbox(
        ...
        key="image_style",
        on_change=update_image_style,
        help="根据对话信息生成相对应场景图片的风格选项",
    )
